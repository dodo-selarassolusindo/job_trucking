...
/**
 * daftar_size controller
 */
class DaftarSizeController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/daftarsize[/{params:.*}]", [PermissionMiddleware::class], "custom.daftar_size")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "DaftarSize");
    }
}
