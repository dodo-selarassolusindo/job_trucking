...
class DepoView extends Depo
{
    ...
    // CSS class/style
    public $CurrentPageName = "depoview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("DepoID") ?? Route("DepoID")) !== null) {
            ...
            $this->RecKey["DepoID"] = $this->DepoID->QueryStringValue;
        } elseif (Post("DepoID") !== null) {
            $this->DepoID->setFormValue(Post("DepoID"));
            $this->RecKey["DepoID"] = $this->DepoID->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->DepoID->setQueryStringValue($keyValue);
            $this->RecKey["DepoID"] = $this->DepoID->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "depolist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "depolist"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
