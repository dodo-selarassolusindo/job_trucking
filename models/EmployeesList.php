...
class EmployeesList extends Employees
{
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->MessengerColor); // MessengerColor
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "TitleOfCourtesy");
            $this->createColumnOption($option, "BirthDate");
            $this->createColumnOption($option, "HireDate");
            ...
            $this->createColumnOption($option, "HomePhone");
            $this->createColumnOption($option, "Extension");
            $this->createColumnOption($option, "Photo");
            $this->createColumnOption($option, "ReportsTo");
            ...
            $this->createColumnOption($option, "Avatar");
            $this->createColumnOption($option, "ActiveStatus");
            $this->createColumnOption($option, "MessengerColor");
            $this->createColumnOption($option, "CreatedAt");
        }
