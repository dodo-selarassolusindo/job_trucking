...
class Job2View extends Job2
{
    ...
    // CSS class/style
    public $CurrentPageName = "job2view";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Job2ID") ?? Route("Job2ID")) !== null) {
            ...
            $this->RecKey["Job2ID"] = $this->Job2ID->QueryStringValue;
        } elseif (Post("Job2ID") !== null) {
            $this->Job2ID->setFormValue(Post("Job2ID"));
            $this->RecKey["Job2ID"] = $this->Job2ID->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Job2ID->setQueryStringValue($keyValue);
            $this->RecKey["Job2ID"] = $this->Job2ID->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "job2list"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "job2list"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
