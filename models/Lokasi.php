...
/**
 * Table class for lokasi
 */
class Lokasi extends DbTable
{
    protected $SqlFrom = "";
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "lokasi";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "LokasiView",
            Config("API_ADD_ACTION") => "LokasiAdd",
            Config("API_EDIT_ACTION") => "LokasiEdit",
            Config("API_DELETE_ACTION") => "LokasiDelete",
            Config("API_LIST_ACTION") => "LokasiList",
            default => ""
        };
    }
