 ...
 * Page class
 */
class PelabuhanEdit extends Pelabuhan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PelabuhanEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "pelabuhanedit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("PelabuhanID") ?? Key(0) ?? Route(2)) !== null) {
                $this->PelabuhanID->setQueryStringValue($keyValue);
                $this->PelabuhanID->setOldValue($this->PelabuhanID->QueryStringValue);
            } elseif (Post("PelabuhanID") !== null) {
                $this->PelabuhanID->setFormValue(Post("PelabuhanID"));
                $this->PelabuhanID->setOldValue($this->PelabuhanID->FormValue);
            } else {
            ...
            if (Post("action", "") !== "") {
                ...
                $loadByQuery = false;
                if (($keyValue = Get("PelabuhanID") ?? Route("PelabuhanID")) !== null) {
                    $this->PelabuhanID->setQueryStringValue($keyValue);
                    $loadByQuery = true;
                } else {
                    $this->PelabuhanID->CurrentValue = null;
                }
            }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("pelabuhanlist"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "pelabuhanlist") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "pelabuhanlist") {
                            ...
                            $returnUrl = "pelabuhanlist"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("pelabuhanlist"), "", $this->TableVar, true);
        $pageId = "edit";
