 ...
 * Page class
 */
class PelabuhanView extends Pelabuhan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PelabuhanView";
    ...
    // CSS class/style
    public $CurrentPageName = "pelabuhanview";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("PelabuhanID") ?? Route("PelabuhanID")) !== null) {
            $this->RecKey["PelabuhanID"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("PelabuhanID") ?? Route("PelabuhanID")) !== null) {
            ...
            $this->RecKey["PelabuhanID"] = $this->PelabuhanID->QueryStringValue;
        } elseif (Post("PelabuhanID") !== null) {
            $this->PelabuhanID->setFormValue(Post("PelabuhanID"));
            $this->RecKey["PelabuhanID"] = $this->PelabuhanID->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->PelabuhanID->setQueryStringValue($keyValue);
            $this->RecKey["PelabuhanID"] = $this->PelabuhanID->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "pelabuhanlist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "pelabuhanlist"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
