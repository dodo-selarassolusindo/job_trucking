 ...
 * Page class
 */
class Size22Delete extends Size22
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Size22Delete";
    ...
    // CSS class/style
    public $CurrentPageName = "size22delete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("size22list"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("size22list"); // Return to list
                return;
            }
        }
