 ...
 * Page class
 */
class Size22View extends Size22
{
    use MessagesTrait;
    ...
    // CSS class/style
    public $CurrentPageName = "size22view";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("SizeID") ?? Route("SizeID")) !== null) {
            ...
            $this->RecKey["SizeID"] = $this->SizeID->QueryStringValue;
        } elseif (Post("SizeID") !== null) {
            $this->SizeID->setFormValue(Post("SizeID"));
            $this->RecKey["SizeID"] = $this->SizeID->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->SizeID->setQueryStringValue($keyValue);
            $this->RecKey["SizeID"] = $this->SizeID->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "size22list"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "size22list"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
