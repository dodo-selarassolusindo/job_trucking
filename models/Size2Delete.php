 ...
 * Page class
 */
class Size2Delete extends Size2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Size2Delete";
    ...
    // CSS class/style
    public $CurrentPageName = "size2delete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("size2list"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("size2list"); // Return to list
                return;
            }
        }
