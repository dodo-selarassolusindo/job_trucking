...
class Size2View extends Size2
{
    ...
    // CSS class/style
    public $CurrentPageName = "size2view";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("SizeID") ?? Route("SizeID")) !== null) {
            ...
            $returnUrl = "size2list"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "size2list"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
