...
/**
 * Table class for size_type
 */
class SizeType extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Size_Type_ID
        $this->Size_Type_ID = new DbField(
            $this, // Table
            'x_Size_Type_ID', // Variable name
            'Size_Type_ID', // Name
            '`Size_Type_ID`', // Expression
            '`Size_Type_ID`', // Basic search expression
            3, // Type
            11, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`Size_Type_ID`', // Virtual expression
            false, // Is virtual
        ...
        $this->Size_Type_ID->InputTextType = "text";
        $this->Size_Type_ID->Raw = true;
        $this->Size_Type_ID->IsAutoIncrement = true; // Autoincrement field
        $this->Size_Type_ID->IsPrimaryKey = true; // Primary key field
        $this->Size_Type_ID->Nullable = false; // NOT NULL field
        $this->Size_Type_ID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Size_Type_ID->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['Size_Type_ID'] = &$this->Size_Type_ID;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "size_type";
    }
    ...
    public function insert(&$rs)
    {
        ...
        if ($result) {
            $this->Size_Type_ID->setDbValue($conn->lastInsertId());
            $rs['Size_Type_ID'] = $this->Size_Type_ID->DbValue;
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        if ($success) {
            if (!isset($rs['Size_Type_ID']) && !EmptyValue($this->Size_Type_ID->CurrentValue)) {
                $rs['Size_Type_ID'] = $this->Size_Type_ID->CurrentValue;
            }
        }
        if ($success && $this->AuditTrailOnEdit && $rsold) {
            $rsaudit = $rs;
            $fldname = 'Size_Type_ID';
    ...
    public function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            if (array_key_exists('Size_Type_ID', $rs)) {
                AddFilter($where, QuotedName('Size_Type_ID', $this->Dbid) . '=' . QuotedValue($rs['Size_Type_ID'], $this->Size_Type_ID->DataType, $this->Dbid));
            }
        }
        $filter = $curfilter ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    {
        return "`Size_Type_ID` = @Size_Type_ID@";
    }
    ...
    {
        $keys = [];
        $val = $current ? $this->Size_Type_ID->CurrentValue : $this->Size_Type_ID->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false, $keySeparator = null)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->Size_Type_ID->CurrentValue = $keys[0];
            } else {
                $this->Size_Type_ID->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter($row = null, $current = false)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('Size_Type_ID', $row) ? $row['Size_Type_ID'] : null;
        } else {
            $val = !EmptyValue($this->Size_Type_ID->OldValue) && !$current ? $this->Size_Type_ID->OldValue : $this->Size_Type_ID->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@Size_Type_ID@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("sizetypelist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "sizetypeview" => $Language->phrase("View"),
            "sizetypeedit" => $Language->phrase("Edit"),
            "sizetypeadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "SizeTypeView",
            Config("API_ADD_ACTION") => "SizeTypeAdd",
            Config("API_EDIT_ACTION") => "SizeTypeEdit",
            Config("API_DELETE_ACTION") => "SizeTypeDelete",
            Config("API_LIST_ACTION") => "SizeTypeList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("sizetypeview", $parm);
        } else {
            $url = $this->keyUrl("sizetypeview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("sizetypeedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("sizetypelist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("sizetypeadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("sizetypelist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("sizetypedelete", $parm);
        }
    }
    ...
    {
        $json = "";
        $json .= "\"Size_Type_ID\":" . VarToJson($this->Size_Type_ID->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->Size_Type_ID->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->Size_Type_ID->CurrentValue);
        } else {
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            $keyValues = $isApi
                ...
                : []; // Non-API
            if (($keyValue = Param("Size_Type_ID") ?? Route("Size_Type_ID")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->Size_Type_ID->CurrentValue = $key;
            } else {
                $this->Size_Type_ID->OldValue = $key;
            }
    ...
    public function renderEditRow()
    {
        ...
        $this->Size_Type_ID->EditValue = $this->Size_Type_ID->CurrentValue;
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'size_type');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'size_type', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'size_type', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'size_type', $fldname, $key, $oldvalue);
            }
        }
    }
