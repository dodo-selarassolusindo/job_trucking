 ...
 * Page class
 */
class SizeTypeAdd extends SizeType
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SizeTypeAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "sizetypeadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "sizetypeview") {
    ...
    protected function getAddRow()
    {
        ...
        // TypeNama
        $this->TypeNama->setDbValueDef($rsnew, $this->TypeNama->CurrentValue, false);
        return $rsnew;
    }
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['TypeNama'])) { // TypeNama
            $this->TypeNama->setFormValue($row['TypeNama']);
        }
    }
