 ...
 * Page class
 */
class SizeTypeDelete extends SizeType
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SizeTypeDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "sizetypedelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("sizetypelist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("sizetypelist"); // Return to list
                return;
            }
        }
