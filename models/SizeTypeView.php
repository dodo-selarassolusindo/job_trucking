 ...
 * Page class
 */
class SizeTypeView extends SizeType
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SizeTypeView";
    ...
    // CSS class/style
    public $CurrentPageName = "sizetypeview";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("Size_Type_ID") ?? Route("Size_Type_ID")) !== null) {
            $this->RecKey["Size_Type_ID"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Size_Type_ID") ?? Route("Size_Type_ID")) !== null) {
            ...
            $this->RecKey["Size_Type_ID"] = $this->Size_Type_ID->QueryStringValue;
        } elseif (Post("Size_Type_ID") !== null) {
            $this->Size_Type_ID->setFormValue(Post("Size_Type_ID"));
            $this->RecKey["Size_Type_ID"] = $this->Size_Type_ID->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Size_Type_ID->setQueryStringValue($keyValue);
            $this->RecKey["Size_Type_ID"] = $this->Size_Type_ID->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "sizetypelist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "sizetypelist"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
