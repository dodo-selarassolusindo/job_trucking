 ...
 * Page class
 */
class TakenByAdd extends TakenBy
{
    use MessagesTrait;
    ...
    // CSS class/style
    public $CurrentPageName = "takenbyadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "takenbyview") {
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['NomorHP'])) { // NomorHP
            $this->NomorHP->setFormValue($row['NomorHP']);
        }
    }
