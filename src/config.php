...
$CONFIG = [
    ...
    "PROJECT_STYLESHEET_FILENAME" => "css/prj_job_trucking.css", // Project stylesheet file name
    ...
    "AES_ENCRYPTION_KEY" => "la3oUsoFU57gYjo7O3XNNhM9AYVjOhAByA2yP4wVaao=", // AES encryption key (base64 encoded)
    ...
    "AUTH_CONFIG" => [
        "providers" => [
            ...
            "Azure" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\prj_job_trucking\\AzureAD',
                "keys" => [
                    "id" => '',
            ...
            "Saml" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\prj_job_trucking\\Saml2',
    ...
    // Export Log
    "EXPORT_PATH" => "export-e946c152-a6fa-4ad7-93dd-22c0e875338d", // Export folder
