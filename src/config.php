...
$CONFIG = [
    ...
    "AES_ENCRYPTION_KEY" => "m990lbaGk2Ie5tARra6dJi7JTBQzopndy2pmbW6gILQ=", // AES encryption key (base64 encoded)
    ...
    // Export Log
    "EXPORT_PATH" => "export-db904388-bbca-46df-8766-6547b7e1d6c1", // Export folder
