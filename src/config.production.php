...
return [
    "Databases" => [
        "DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => "3306", "user" => "root", "password" => "", "dbname" => "db_job_trucking"]
    ],
    "SMTP" => [
    ...
    "JWT" => [
        "SECRET_KEY" => "qVU05qRlE3S8Tmmt8PJjNGQ/86dMhB03v+hxGuaRnCQ=", // JWT secret key
