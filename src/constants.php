...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "24.10.0");

// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "prj_job_trucking"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{DB904388-BBCA-46DF-8766-6547B7E1D6C1}"); // Project ID
