...
$USER_LEVEL_PRIVS = [["{E946C152-A6FA-4AD7-93DD-22C0E875338D}audittrail","-2","0"],
    ...
    ["{E946C152-A6FA-4AD7-93DD-22C0E875338D}job_order","-2","0"],
    ...
    ["{E946C152-A6FA-4AD7-93DD-22C0E875338D}job_order2.php","-2","72"],
    ["{E946C152-A6FA-4AD7-93DD-22C0E875338D}job_order2.php","0","0"]];
...
$USER_LEVEL_TABLES = [["audittrail","audittrail","Log Activity",true,"{E946C152-A6FA-4AD7-93DD-22C0E875338D}","audittraillist"],
    ["beranda.php","beranda","Job Order",true,"{E946C152-A6FA-4AD7-93DD-22C0E875338D}","beranda"],
    ...
    ["job_order2.php","job_order2","Container Job Order",true,"{E946C152-A6FA-4AD7-93DD-22C0E875338D}","joborder2"]];
