...
<span id="el_job_Customer">
    <select
        ...
        data-select2-id="fjobadd_x_Customer"
        data-table="job"
...
<script>
loadjs.ready("fjobadd", function() {
    var options = { name: "x_Customer", selectId: "fjobadd_x_Customer" };
    if (fjobadd.lists.Customer?.lookupOptions.length) {
        options.data = { id: "x_Customer", form: "fjobadd" };
    } else {
        options.ajax = { id: "x_Customer", form: "fjobadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
