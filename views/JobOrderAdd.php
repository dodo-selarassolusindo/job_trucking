...
<script>
loadjs.ready("fjob_orderadd", function() {
    fjob_orderadd.createAutoSuggest(Object.assign({"id":"x_IsOpen","forceSelect":false}, { lookupAllDisplayFields: <?= $Page->IsOpen->Lookup->LookupAllDisplayFields ? "true" : "false" ?> }, ew.vars.tables.job_order.fields.IsOpen.autoSuggestOptions));
});
</script>
</span>
</div></div>
