...
$topMenu->addMenuItem(20, "mi_size", $Language->menuPhrase("20", "MenuText"), "sizelist", 16, "", AllowListMenu('{DB904388-BBCA-46DF-8766-6547B7E1D6C1}size'), false, false, "", "", true, false);
...
$sideMenu->addMenuItem(20, "mi_size", $Language->menuPhrase("20", "MenuText"), "sizelist", 16, "", AllowListMenu('{DB904388-BBCA-46DF-8766-6547B7E1D6C1}size'), false, false, "", "", true, true);
